...
class LineChart: UIView {
    ...
    private func setupView() {
        ...
        self.backgroundColor = UIColor.lookerBlack
        // スクロールは無効にしておく
    ...
    private func maskGradientLayer() {
        if let dataPoints = dataPoints,
            ...
            maskLayer.fillColor = UIColor.lookerBlue.cgColor
            maskLayer.strokeColor = UIColor.lookerBlue.cgColor
    ...
    private func drawLables() {
        if let dataEntries = dataEntries,
            ...
            for i in 0..<dataEntries.count {
                ...
                textLayer.foregroundColor = UIColor.lookerWhite.cgColor
    ...
    private func drawHorizontalLines() {
        ...
        if let gridValues = gridValues {
            for value in gridValues {
                ...
                lineLayer.path = path.cgPath
                lineLayer.fillColor = UIColor.clear.cgColor
                lineLayer.strokeColor = UIColor.lookerGray.cgColor
                ...
                textLayer.foregroundColor = UIColor.lookerGray.cgColor
                textLayer.backgroundColor = UIColor.clear.cgColor
                textLayer.contentsScale = UIScreen.main.scale
                textLayer.font = CTFontCreateWithName(UIFont.systemFont(ofSize: 0).fontName as CFString, 0, nil)
